...
onMounted(() => {
  ...
  darkmodeToggle.value = (darkmodeState === null || darkmodeState === "DarkMode") ? false : true
})

const onToggleDarkmode = () => {
  if (!darkmodeToggle.value) localStorage.setItem('DarkMode', JSON.stringify('darkmode'))
  else {
...
<template>
  <header :class="{ darkmode: darkmodeToggle }" class="gAffOP">
    <nav class="FTZjD">
      <a aria-current="page" aria-label="home page" class="header__Link-sc-1lpxlh0-2 iAukjk home-icon" href="/"><svg
          width="40" height="40" viewBox="0 0 50 50" fill="none">
          <path
      ...
      <ul class="eQaOKO">
        ...
        <li>
          <RouterLink to="/heroForm">Create Hero</RouterLink>
        </li>
        <li>
      ...
      <label class="relative inline-flex items-center cursor-pointer" style="margin-right:20px">
        <span class="ml-3  font-medium text-gray-900 dark:text-gray-300" style="margin-right:10px">{{
          darkmodeToggle ?
          "Whitemode" : "Darkmode" }}</span>
        <input type="checkbox" class="sr-only peer" v-model="darkmodeToggle" @click="onToggleDarkmode" />
        <div
...
/*!sc*/
data-styled.g5[id='button__Button-sc-5mhuas-0'] {
  content: 'eaVWqN,kGyvkr,';
}
...
/*!sc*/
data-styled.g7[id='sc-global-iEDSUG1'] {
...
/*!sc*/
.gAffOP .home-icon svg {
  fill: #333;
}

/*!sc*/
data-styled.g8[id='header__Header-sc-1lpxlh0-0'] {
  content: 'gAffOP,';
}
...
/*!sc*/
data-styled.g10[id='header__Link-sc-1lpxlh0-2'] {
  content: 'iAukjk,';
}
...
/*!sc*/
.eQaOKO li:not(:last-child) {
  margin-right: 1.75rem;
}

/*!sc*/
data-styled.g11[id='header__List-sc-1lpxlh0-3'] {
  content: 'eQaOKO,';
}
...
/*!sc*/
data-styled.g12[id='header__Button-sc-1lpxlh0-4'] {
  content: 'cLvlSE,';
}
...
/*!sc*/
data-styled.g16[id='layout__Main-sc-1tka7c-0'] {
  content: 'fNGvPz,';
}
...
/*!sc*/
data-styled.g22[id='showcase__Inner-sc-1x4wk68-1'] {
  content: 'hVhElu,';
}
...
/*!sc*/
data-styled.g23[id='hero__Wrapper-sc-1h2eool-0'] {
  content: 'lgTwHp,';
}
...
/*!sc*/
data-styled.g24[id='hero__Title-sc-1h2eool-1'] {
  content: 'jiKqlM,';
}
